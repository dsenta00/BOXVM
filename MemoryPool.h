...
public:
	...
	~MemoryPool();
    void ExpandSize(Size, Size &);
	void Free(Address, Size);
    Address Malloc(Size, Size &);
protected:
...
void MemoryPool::ExpandSize(Size _size, Size &change)
{
	Address newvmp = null;
	size += _size + EXTRASPACE;
...
Address MemoryPool::Malloc(Size _size, Size &change)
{
